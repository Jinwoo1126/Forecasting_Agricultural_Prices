                    ...
                    if item_ensemble_weight_list[2] > 0.:
                        ...
                        for step in [1,2,3]:
                            ...
                            for i in range(1, n_splits+1):
                                ...
                                xgb_pred_ += np.expm1(model.predict(xgb.DMatrix(data=pd.get_dummies(fe_target_test_df.loc[0:, tree_feature])))[0])/n_splits
                    ...
                    if item_ensemble_weight_list[1] > 0.:
                        ...
                        for step in [1,2,3]:
                            ...
                            for i in range(1, n_splits+1):
                                ...
                                lgb_pred_ += np.expm1(model.predict(fe_target_test_df.loc[0:, tree_feature])[0])/n_splits
